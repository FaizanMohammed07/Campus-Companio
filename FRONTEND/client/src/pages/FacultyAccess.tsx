...
// Voice removed: local interactions only
import {
  Select,
  SelectContent,
  SelectItem,
...
export default function FacultyAccess() {
  ...
  // voice removed: currentTask previously tracked here
    ...
    <div className="min-h-screen p-6 max-w-lg mx-auto flex flex-col">
      ...
      {view === "delivery" && (
        <div className="space-y-6 animate-in slide-in-from-right-8">
          ...
          <Button
            size="lg"
            className="w-full h-16 rounded-2xl text-xl gap-2 shadow-lg shadow-primary/20"
