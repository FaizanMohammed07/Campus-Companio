...
export default function VisitorHelp() {
  ...
  const { currentTask } = useVoiceController();
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-primary text-primary-foreground relative overflow-hidden">
        ...
        >
          ...
          <p className="text-xl opacity-90">Heading to {selectedLoc?.name || "Destination"}</p>
        ...
        <DialogContent className="rounded-3xl max-w-sm">
          <DialogHeader>
            ...
            <DialogDescription className="text-center text-lg pt-2">
              This is located in <span className="font-bold text-primary">{selectedLoc?.block}</span>.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="flex flex-col gap-3 pb-2">
            <Button size="lg" className="w-full rounded-xl h-14 text-lg gap-2" onClick={handleStartGuide}>
